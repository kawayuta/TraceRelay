document.addEventListener("DOMContentLoaded", () => {
  ...
  const initResizableGroups = () => {
    ...
    const storageKeyFor = (group, handle) =>
      `${group.dataset.resizableKey || "schemaledger.layout"}.${handle.dataset.resizeVar || "pane"}`;
  ...
  const keys = {
    search: "schemaledger.tasks.search",
    status: "schemaledger.tasks.status",
    family: "schemaledger.tasks.family",
    compare: "schemaledger.tasks.compare",
  };
