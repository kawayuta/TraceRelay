...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply SchemaLedger PostgreSQL schema and optionally reindex artifacts.")
    ...
    if args.json:
        ...
        return
    print(
        "Applied SchemaLedger schema to PostgreSQL"
