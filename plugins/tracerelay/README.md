...
Codex connects to the running docker-compose MCP server through `.codex-plugin/mcp.json`.
...
Claude Code uses the root `.mcp.json` and expects the docker-compose MCP server to already be running.
