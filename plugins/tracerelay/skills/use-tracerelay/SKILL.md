...
- If the user asks for continuation, memory recall, or "what changed", use TraceRelay first and only fall back to generic reasoning after checking the runtime state.
